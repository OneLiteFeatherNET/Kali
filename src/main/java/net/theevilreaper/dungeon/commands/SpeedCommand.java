...
public class SpeedCommand extends Command {
    ...
    private static final Component VALUE_IS_TO_HIGH =
            DungeonEditor.PREFIX.append(Component.text("The given speed is to high. The maximum is 10", NamedTextColor.RED));

    private static final Component NO_NUMBER =
            DungeonEditor.PREFIX.append(Component.text("The given value is not a number", NamedTextColor.RED));

    private static final Component RESET_TO_DEFAULT =
            DungeonEditor.PREFIX.append(Component.text("Speed has been reset to default", NamedTextColor.GREEN));
    ...
    public void onSelf(@NotNull CommandSender sender, @NotNull CommandContext context) {
        ...
        player.sendMessage(DungeonEditor.PREFIX.append(Component.text("Changed speed value")));
    }
}
